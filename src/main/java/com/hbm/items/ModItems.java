...
public class ModItems {
	...
	public static final Item record_ussr_anthem = new ItemModRecord("ussr_anthem", HBMSoundHandler.ussrAnthem, "record_ussr_anthem").setCreativeTab(CreativeTabs.MISC);
	public static final Item record_melyallam_kemia_terem_instrumental = new ItemModRecord("melyallam_kemia_terem_instrumental", HBMSoundHandler.melyallamKemiaTeremInstrumental, "record_melyallam_kemia_terem_instrumental").setCreativeTab(CreativeTabs.MISC);
	public static final Item record_o7_lofi_type_beat = new ItemModRecord("o7_lofi_type_beat", HBMSoundHandler.o7LofiTypeBeat, "record_o7_lofi_type_beat").setCreativeTab(CreativeTabs.MISC);
	public static final Item record_o7_relaxed_vibes = new ItemModRecord("o7_relaxed_vibes", HBMSoundHandler.o7RelaxedVibes, "record_o7_relaxed_vibes").setCreativeTab(CreativeTabs.MISC);
	public static final Item record_o7_trumpet_trap_type_beat = new ItemModRecord("o7_trumpet_trap_type_beat", HBMSoundHandler.o7TrumpetTrapTypeBeat, "record_o7_trumpet_trap_type_beat").setCreativeTab(CreativeTabs.MISC);
	public static final Item record_o7_violin_trap_type_beat = new ItemModRecord("o7_violin_trap_type_beat", HBMSoundHandler.o7ViolinTrapTypeBeat, "record_o7_violin_trap_type_beat").setCreativeTab(CreativeTabs.MISC);

...
//		Refine puke sounds to have splashy sound.
//		Pegasi and Missile silo achievement typo fix.
//		Oppenheimer meme before gadget explosion.
//		Fix antimatter barrel scale (make it 5x5 from 4x4)
//		Infintie barell which destroys a lot of fluid in a second (fluid destroyer)
...
public class RefStrings {
	...
	public static final String CHANGELOG = "§a+ Added some surprises.";
